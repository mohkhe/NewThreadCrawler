...
public class diff_match {
  ...
  private LinkedList<Diff> diff_compute(String text1, String text2,
    ...
    if (checklines && text1.length() > 100 && text2.length() > 100) {
    	LinkedList<Diff> diffsTemp = new LinkedList<Diff>();
        try{
        	diffsTemp = diff_lineMode(text1, text2, deadline);
    ...
    LinkedList<Diff> diffsTemp = new LinkedList<Diff>();
    try{
    	diffsTemp = diff_bisect(text1, text2, deadline);
    }catch(java.lang.OutOfMemoryError e){
    	System.out.println("OutOfMEmory Exception.");
    }
    return diffsTemp; 
  ...
  protected LinkedList<Diff> diff_bisect(String text1, String text2,
      long deadline) throws java.lang.OutOfMemoryError {
